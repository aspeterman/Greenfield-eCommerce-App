...
import ProductView from './overall/ProductView.jsx';
import defaultProduct from './overall/defaultProduct.jsx';
...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      <ProductView productInfo={this.state.selectedProduct} />
      </div>
    )
  }
}
